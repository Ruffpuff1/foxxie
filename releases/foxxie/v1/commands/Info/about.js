...
module.exports = {
	...
	execute(message, args) {
		...
		const aboutEmbed = new Discord.MessageEmbed()
			...
			.setDescription(
				'Foxie is a developmental project by <@486396074282450946> as a fun way of learning Discord.js. Currently being used in his server **The Corner Store**.'
			)
			.addFields(
				{
					name: 'Created',
					value: `Foxie was created on **${creation}**`,
					inline: true
				},
			...
			.addFields(
				{
					name: 'Servers',
					value: 'Foxie is helping with ' + `**2**` + ' servers!',
					inline: false
				},
				{
