...
@ApplyOptions<ListenerOptions>({
    event: FoxxieEvents.VoiceChannelUndeafened
})
export class UserListener extends Listener<FoxxieEvents.VoiceChannelUndeafened> {
    public run(...[state]: EventArgs<FoxxieEvents.VoiceChannelUndeafened>): void {
        this.container.client.emit(FoxxieEvents.GuildMessageLog, state.guild, GuildSettings.Channels.Logs.MessageVoice, t =>
            new EmbedBuilder() //
                .setAuthor({
                    name: 'User Undeafened',
