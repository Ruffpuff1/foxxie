...
module.exports = class extends Language {
    ...
    constructor(...args) {
        ...
        this.language = {
            ...
            COMMAND_SMILE_DESCRIPTION: `Give a jolly sweet smile (because you look pretty when you smile :D)`,
            COMMAND_SMILE_FOOTER: (sender, reciever, authNum, recNum) => `${reciever} smiled ${recNum} times and ${sender} smiled at others ${authNum} times`,
            COMMAND_SMILE_MULTIPLE: (sender, reciever) => `${bold`${sender}`} smiles at ${bold`${reciever}`}`,
            COMMAND_SMILE_SELF: `is smiling`,
            COMMAND_SMILE_SINGLE: (sender, reciever) => `${bold`${sender}`} smiled at ${bold`${reciever}`}`,
