...
module.exports = {
    ...
    name: 'template',
        ...
        COMMAND_SERVERLIST_EMBED_FOOTER: (size, page, totalPages) => ``,
        COMMAND_SERVERLIST_EMBED_TITLE: ``,
        COMMAND_SERVERLIST_MEMBERCOUNT: ``,
        ...
        COMMAND_BAN_DM_DESCRIPTION: (guild, reason) => ``,
        COMMAND_BAN_DM_TITLE: guild => ``,
        COMMAND_BAN_NOMEMBER: ``,
        COMMAND_CLEARNOTE_DESCRIPTION: ``,
        ...
        COMMAND_CLEARWARN_INVALIDWARNID: ``,
        COMMAND_KICK_DESCRIPTION: ``,
        COMMAND_KICK_DM_DESCRIPTION: (guild, reason) => ``,
        COMMAND_KICK_DM_TITLE: guild => ``,
        COMMAND_KICK_NOMEMBER: ``,
        COMMAND_LOCK_ALREADY: ``,
        COMMAND_LOCK_DESCRIPTION: ``,
        COMMAND_LOCK_LOCKING: ``,
        COMMAND_LOCK_SUCCESS: ``,
        COMMAND_MUTE_DESCRIPTION: ``,
        COMMAND_MUTE_NOMEMBER: ``,
        COMMAND_MUTE_ROLE_DEFAULT: ``,
        COMMAND_MUTE_ROLE_REASON: ``,
        COMMAND_NOTE_DESCRIPTION: ``,
        COMMAND_NOTE_NOMEMBER: ``,
        COMMAND_NOTE_NONOTE: ``,
        COMMAND_NUKE_CANCELLED: ``,
        COMMAND_NUKE_DESCRIPTION: ``,
        COMMAND_NUKE_FIRST: ``,
        COMMAND_NUKE_NOTOWNER: ``,
        COMMAND_NUKE_WARNING: (auth, channel) => ``,
        COMMAND_PURGE_DESCRIPTION: ``,
        COMMAND_PURGE_INVALIDAGE: ``,
        COMMAND_PURGE_INVALIDSIZE: ``,
        COMMAND_PURGE_SUCCESS: ``,
        COMMAND_PURGE_ZEROMESSAGES: ``,
        COMMAND_SLOWMODE_DESCRIPTION: ``,
        COMMAND_SLOWMODE_NOARGS: ``,
        COMMAND_SLOWMODE_NOTNUMBER: ``,
        COMMAND_SLOWMODE_NOTTIME: ``,
        ...
        COMMAND_UNBAN_DM_DESCRIPTION: (guild, reason) => ``,
        COMMAND_UNBAN_DM_TITLE: guild => ``,
        COMMAND_UNBAN_NOUSER: ``,
        COMMAND_UNLOCK_DESCRIPTION: ``,
        COMMAND_UNLOCK_NOTLOCKED: ``,
        COMMAND_UNLOCK_SUCCESS: ``,
        COMMAND_UNLOCK_UNLOCKING: ``,
        ...
        COMMAND_WARN_NOMEMBER: ``,

        // Roleplay Commands
        COMMAND_ANGRY_DESCRIPTION: ``,
        COMMAND_ANGRY_FOOTER: (sender, reciever, authNum, recNum) => ``,
        COMMAND_ANGRY_MULTIPLE: (sender, reciever) => ``,
        COMMAND_ANGRY_SELF: ``,
        COMMAND_ANGRY_SINGLE: (sender, reciever) => ``,
        ...
        COMMAND_LICK_FOOTER: (sender, reciever, authNum, recNum) => ``,
        COMMAND_LICK_MULTIPLE: (sender, reciever) => ``,
        COMMAND_LICK_SINGLE: (sender, reciever) => ``,
        ...
        COMMAND_SLEEP_FOOTER: (sender, reciever, authNum, recNum) => ``,
        COMMAND_SLEEP_MULTIPLE: (sender, reciever) => ``,
        COMMAND_SLEEP_SELF: ``,
        COMMAND_SLEEP_SINGLE: (sender, reciever) => ``,
        ...
        COMMAND_DISBOARD_CHANNEL_NOCHANNEL: ``,
        COMMAND_DISBOARD_CHANNEL_NOW: channel => ``,
        COMMAND_DISBOARD_CHANNEL_REMOVED: ``,
        COMMAND_DISBOARD_CHANNEL_SET: channel => ``,
        COMMAND_DISBOARD_DESCRIPTION: ``,
        COMMAND_DISBOARD_INVALIDUSE: ``,
        COMMAND_DISBOARD_MESSAGE_NOMESSAGE: ``,
        COMMAND_DISBOARD_MESSAGE_NOW: message => ``,
        COMMAND_DISBOARD_MESSAGE_REMOVED: ``,
        COMMAND_DISBOARD_MESSAGE_SET: message => ``,
        COMMAND_GOODBYE_DESCRIPTION: ``,
        COMMAND_GOODBYE_CHANNEL_NOCHANNEL: ``,
        COMMAND_GOODBYE_CHANNEL_NOW: channel => ``,
        COMMAND_GOODBYE_CHANNEL_REMOVED: ``,
        COMMAND_GOODBYE_CHANNEL_SET: channel => ``,
        COMMAND_GOODBYE_INVALIDUSE: ``,
        COMMAND_GOODBYE_MESSAGE_NOMESSAGE: ``,
        ...
        COMMAND_LOG_CONFIRM: ``,
        COMMAND_LOG_DELETE_NOCHANNEL: ``,
        COMMAND_LOG_DELETE_NOW: channel => ``,
        COMMAND_LOG_DELETE_REMOVED: ``,
        COMMAND_LOG_DELETE_SET: channel => ``,
        COMMAND_LOG_DESCRIPTION: ``,
        COMMAND_LOG_EDIT_NOCHANNEL: ``,
        COMMAND_LOG_EDIT_NOW: channel => ``,
        COMMAND_LOG_EDIT_REMOVED: ``,
        COMMAND_LOG_EDIT_SET: channel => ``,
        COMMAND_LOG_INVALIDUSE: ``,
        COMMAND_LOG_MOD_NOCHANNEL: ``,
        COMMAND_LOG_MOD_NOW: channel => ``,
        COMMAND_LOG_MOD_REMOVED: ``,
        COMMAND_LOG_MOD_SET: channel => ``,
        ...
        COMMAND_STARBOARD_CHANNEL_NOCHANNEL: ``,
        COMMAND_STARBOARD_CHANNEL_NOW: channel => ``,
        COMMAND_STARBOARD_CHANNEL_REMOVED: ``,
        COMMAND_STARBOARD_CHANNEL_SET: channel => ``,
        COMMAND_STARBOARD_DESCRIPTION: ``,
        COMMAND_STARBOARD_INVALIDUSE: ``,
        COMMAND_STARBOARD_MINIMUM_NOW: minimum => ``,
        COMMAND_STARBOARD_MINIMUM_REMOVED: ``,
        COMMAND_STARBOARD_MINIMUM_SET: minimum => ``,
        ...
        COMMAND_TESTDISBOARD_DESCRIPTION: ``,
        COMMAND_TESTJOIN_DESCRIPTION: ``,
        COMMAND_TESTLEAVE_DESCRIPTION: ``,
        ...
        // Utility Commands
        COMMAND_ABOUT_COMMANDS_TITLE: ``,
        COMMAND_ABOUT_COMMANDS_VALUE: ``,
        COMMAND_ABOUT_CREATED_TITLE: ``,
        COMMAND_ABOUT_CREATED_VALUE: date => ``,
        COMMAND_ABOUT_CREDITS_TITLE: ``,
        COMMAND_ABOUT_CREDITS_VALUE: ``,
        COMMAND_ABOUT_DESCRIPTION: ``,
        COMMAND_ABOUT_GUILDS_TITLE: ``,
        COMMAND_ABOUT_GUILDS_VALUE: guilds => ``,
        COMMAND_ABOUT_SUMMARY: ``,
        COMMAND_ABOUT_TITLE: ``,
        COMMAND_ABOUT_USERS_TITLE: ``,
        COMMAND_ABOUT_USERS_VALUE: users => ``,
        COMMAND_ABOUT_VERSION_TITLE: ``,
        COMMAND_ABOUT_VERSION_VALUE: ``,
        COMMAND_AFK_DESCRIPTION: ``,
        COMMAND_AFK_EMBED_AUTHOR: user => ``,
        COMMAND_AFK_EMBED_DESCRIPTION: reason => ``,
        COMMAND_AVATAR_DESCRIPTION: ``,
        COMMAND_AVATAR_FOXXIE: ``,
        ...
        COMMAND_BUGREPORT_CANCELLED: ``,
        COMMAND_BUGREPORT_DESCRIPTION: ``,
        COMMAND_BUGREPORT_NOBUG: ``,
        ...
        COMMAND_INFO_EMOJI_ANIMATED_TITLE: ``,
        COMMAND_INFO_EMOJI_ANIMATED_VALUE: (animated) => ``,
        COMMAND_INFO_EMOJI_CREATED: (name, date, ago) => ``,
        COMMAND_INFO_EMOJI_LINKS_TITLE: ``,
        COMMAND_INFO_EMOJI_NAME_TITLE: ``,
        COMMAND_INFO_ROLE_CREATED_TITLE: ``,
        COMMAND_INFO_ROLE_CREATED_VALUE: (days, ago) => ``,
        COMMAND_INFO_ROLE_PERMISSIONS_TITLE: ``,
        COMMAND_INFO_ROLE_ALLPERMS: ``,
        COMMAND_INFO_ROLE_COLOR: ``,
        COMMAND_INFO_ROLE_MEMBERS_TITLE: ``,
        COMMAND_INFO_ROLE_MEMBERS_VALUE: (humans, bots) => ``,
        COMMAND_INFO_ROLE_NONE: ``,
        COMMAND_INFO_ROLE_PROPERTIES_ARRAY: (hoist, mention, manage, role) => [].join('\n'),
        COMMAND_INFO_ROLE_PROPERTIES_TITLE: ``,
        ...
        COMMAND_INVITE_EMBED_TITLE: ``,
        COMMAND_INVITE_EMBED_DESCRIPTION: ``,
        ...
        COMMAND_POLL_EMBED_FOOTER: ``,
        COMMAND_POLL_EMBED_TITLE: user => ``,
        COMMAND_POLL_TOOFEW: ``,
        COMMAND_POLL_TOOMANY: ``,
        COMMAND_REDEEMKEY_DESCRIPTION: ``,
        COMMAND_REDEEMKEY_NOEXIST: ``,
        COMMAND_REDEEMKEY_NOKEY: ``,
        COMMAND_REDEEMKEY_SUCCESS: (icon, title) => ``,
        COMMAND_REMINDME_DESCRIPTION: ``,
        COMMAND_REMINDME_INVALIDTIME: ``,
        COMMAND_REMINDME_NOREASON: ``,
        COMMAND_REMINDME_NOTIME: ``,
        COMMAND_REMINDME_SUCCESS: time => ``,
        COMMAND_SETCOLOR_DESCRIPTION: ``,
        COMMAND_SETCOLOR_INVALIDCOLOR: ``,
        COMMAND_SETCOLOR_NOPERMS: ``,
        COMMAND_SETCOLOR_NOROLE: ``,
        COMMAND_SHORTEN_DESCRIPTION: ``,
        COMMAND_SHORTEN_ERROR: name => ``,
        COMMAND_SHORTEN_NOARGS: ``,
        COMMAND_SHORTEN_SUCCESS: url => ``,
        COMMAND_SHORTEN_SUCCESS_NAME: (name, url) => ``,
        COMMAND_STEAL_DESCRIPTION: ``,
        COMMAND_STEAL_MAXEMOJI: ``,
        COMMAND_STEAL_NOARGS: ``,
        COMMAND_STEAL_NOTEMOJI: ``,
        COMMAND_STEAL_SUCCESS: name => ``,
        COMMAND_SUPPORT_BODY: ``,
        COMMAND_SUPPORT_DESCRIPTION: ``,
        COMMAND_SUPPORT_HERE: ``,
        COMMAND_UPTIME: (d, h, m, s) => ``,
        COMMAND_UPTIME_DESCRIPTION: ``,
        ...
        COMMAND_WOLFRAM_DESCRIPTION: ``,
        COMMAND_WOLFRAM_NO_ARGS: ``,
        COMMAND_WOLFRAM_NO_DATA: ``,

        // Events
        EVENT_AUTOROLE_REASON: ``,
        EVENT_BOTROLE_REASON: ``,
        EVENT_GUILDMEMBERADD_DEFAULT_WELCOMEMESSAGE: member => ``,
        EVENT_GUILDMEMBERADD_PERSISTREASON: ``,
        EVENT_GUILDMEMBERREMOVE_DEFAULT_GOODBYEMESSAGE: member => ``,
        EVENT_MESSAGEDELETE_EMBED_TITLE: auth => ``,
        EVENT_MESSAGEDELETE_EMBED_DESCRIPTION: (auth, channel) => ``,
        EVENT_MESSAGEDELETE_EMBED_MESSAGECONTENT: ``,
        EVENT_MESSAGEDELETE_EMBED_MESSAGEID: ``,
        EVENT_MESSAGEUPDATE_EMBED_TITLE: auth => ``,
        EVENT_MESSAGEUPDATE_EMBED_DESCRIPTION: (auth, channel) => ``,
        EVENT_MESSAGEUPDATE_EMBED_MESSAGEAFTER: ``,
        EVENT_MESSAGEUPDATE_EMBED_MESSAGEBEFORE: ``,
        EVENT_MESSAGEUPDATE_EMBED_MESSAGEID: ``,
        EVENT_MESSAGEUPDATE_EMBED_MESSAGELINK: link => ``,
