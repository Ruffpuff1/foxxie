...
const Museum: NextPage = () => {
    const letters = [...new Set(museums.map(m => m.name.slice(0, 1)))];
    ...
    return (
        <>
            ...
            <NextSeo
                title={`Museums - Reese Arts & Culture`}
                description=''
                openGraph={{
                    title: `Museums - Reese Arts & Culture`,
                    description: ''
            ...
            <div className='left-0 top-[3rem] mt-[7rem] flex flex-col items-center'>
                <h1 className='text-3xl tracking-[.00625em]'>Museums</h1>
                                        ...
                                        <a className='block h-full w-full overflow-hidden text-[.875rem] font-[500] leading-[1.25rem]' href={m.page}>
                                            <div className='h-full w-full overflow-hidden'>
                                                ...
                                                <div className='w-full text-start'>
                                                    ...
                                                    <h4 className='max-h-[2rem] overflow-hidden text-ellipsis pr-1 text-[.75rem] text-[#80868b]'>{m.location}</h4>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
