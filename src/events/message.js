...
module.exports = {
	...
	execute: async(message) => {
            ...
            // mimu pick command
            if (message.guild.id === '826985018182074391' && message.content.toLowerCase() === '.pick') return message.channel.send('**Darlin\'** I\'m flattered you want to pick me but again mimu\'s prefix is \`?\`.')
