...
export class FoxxieSubcommand extends Subcommand<FoxxieSubcommand.Args, FoxxieSubcommand.Options> {
    ...
    public declare readonly detailedDescription: TypedFT<DetailedDescriptionArgs, DetailedDescription>;
    ...
    protected parseConstructorPreConditions(options: FoxxieSubcommand.Options): void {
