...
// import { Listener, ListenerOptions, LoaderPieceContext } from '@sapphire/framework';
...
//     public constructor(context: LoaderPieceContext<'listeners'>, options: ModerationListener.Options) {
