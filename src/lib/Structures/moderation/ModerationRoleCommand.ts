...
//             const role = await this.container.utilities
//                 .guild(message.guild)
//                 .moderation.actions.setUpRole(message, this.setUpKey);
...
//     protected async askForRole(
//         message: GuildMessage,
//         args: ModerationRoleCommand.Args,
//         context: ModerationRoleCommand.Context
//     ) {
