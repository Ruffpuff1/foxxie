...
interface ApiChannelsChannel {
     ...
     */
    get(): Promise<RESTGetAPIChannelResult>;
     ...
     * @url https://discord.com/developers/docs/resources/channel#modify-channel
     */
    patch(data: { data: RESTPatchAPIChannelJSONBody; reason?: string }): Promise<RESTPatchAPIChannelResult>;
...
interface ApiChannelsChannelMessages {
     ...
     */
    post(data: { data: RESTPostAPIChannelMessageJSONBody }): Promise<RESTPostAPIChannelMessageResult>;
...
interface ApiChannelsChannelMessagesMessageReactions {
     ...
     */
    delete(): Promise<RESTDeleteAPIChannelAllMessageReactionsResult>;
...
interface ApiChannelsChannelMessagesMessageReactionsEmoji {
     ...
     */
    get(data?: { query?: RESTGetAPIChannelMessageReactionUsersQuery }): Promise<RESTGetAPIChannelMessageReactionUsersResult>;
...
interface ApiChannelsChannelPermissionsPermission {
     ...
     */
    put(data: { data: RESTPutAPIChannelPermissionJSONBody; reason?: string }): Promise<RESTPutAPIChannelPermissionResult>;
...
interface ApiChannelsChannelInvites {
     ...
     */
    post(data: RESTPostAPIChannelInviteJSONBody): Promise<RESTPostAPIChannelInviteResult>;
}
...
interface ApiGuildsGuildMembersMember {
     ...
     */
    get(): Promise<RESTGetAPIGuildMemberResult>;
     ...
     */
    put(data?: RESTPutAPIGuildMemberJSONBody): Promise<RESTPutAPIGuildMemberResult>;
     ...
     */
    patch(data: { data: RESTPatchAPIGuildMemberJSONBody; reason?: string }): Promise<RESTPatchAPIGuildMemberResult>;
     ...
     */
    delete(data?: { reason: string }): Promise<RESTDeleteAPIGuildMemberResult>;
...
interface ApiGuildsGuildMembersMemberRolesRole {
     ...
     */
    put(data?: { reason?: string }): Promise<RESTPutAPIGuildMemberRoleResult>;
...
interface ApiGuildsGuildBansUser {
     ...
     */
    get(): Promise<RESTGetAPIGuildBanResult>;
     ...
     */
    put(data?: RESTPutAPIGuildBanJSONBody): Promise<RESTPutAPIGuildBanResult>;
    //  put: (data?: RESTPutAPIGuildBanJSONBody): Promise<RESTPutAPIGuildBanResult>;
     ...
     */
    delete(data?: { reason?: string }): Promise<RESTDeleteAPIGuildBanResult>;
}
...
interface ApiGuildsGuildRoles {
     ...
     */
    post(data?: { data?: RESTPostAPIGuildRoleJSONBody; reason?: string }): Promise<RESTPostAPIGuildRoleResult>;
     ...
     */
    patch(data?: RESTPatchAPIGuildRolePositionsJSONBody): Promise<RESTPatchAPIGuildRolePositionsResult>;
...
interface ApiGuildsGuildRolesRole {
     ...
     */
    delete(data?: { reason: string }): Promise<RESTDeleteAPIGuildRoleResult>;

    /**
     * Modify a guild role. Requires the `MANAGE_ROLES` permission. Returns the updated role on success. Fires a
     * Guild Role Update Gateway event.
     * @url https://discord.com/developers/docs/resources/guild#modify-guild-role
     */
    patch(data: { data: RESTPatchAPIGuildRoleJSONBody; reason?: string }): Promise<RESTPatchAPIGuildRoleResult>;
}
...
interface ApiInvitesInvite {
     ...
     */
    get(data?: RESTGetAPIInviteQuery): Promise<RESTGetAPIInviteResult>;
...
interface ApiUsersMe {
     ...
     */
    get(): Promise<RESTGetAPICurrentUserResult>;

    /**
     * Modify the requester's user account settings. Returns a user object on success.
     * @url https://discord.com/developers/docs/resources/user#modify-current-user
     */
    patch(data?: RESTPatchAPICurrentUserJSONBody): Promise<RESTPatchAPICurrentUserResult>;
...
interface ApiUsersMeGuilds {
     ...
     */
    get(data?: RESTGetAPICurrentUserGuildsQuery): Promise<RESTGetAPICurrentUserGuildsResult>;
...
interface ApiUsersMeGuildsGuild {
     ...
     */
    delete(): Promise<RESTDeleteAPICurrentUserGuildResult>;
}
...
interface ApiUsersMeChannels {
     ...
     */
    post(data: { data: RESTPostAPICurrentUserCreateDMChannelJSONBody }): Promise<RESTPostAPICurrentUserCreateDMChannelResult>;
}
