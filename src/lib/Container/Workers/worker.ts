...
// import { HighlightTypeEnum, IncomingPayload, IncomingType, OutgoingHighlightPayload, OutgoingPayload, OutputType, RunHighlightPayload } from "./types";
...
// 				for (const { word, userId } of cast<Highlight[]>(
