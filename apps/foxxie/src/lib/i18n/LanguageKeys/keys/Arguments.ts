...
export const BirthdayYear = FT<{ msg: string; year: number }>('arguments:birthdayYear');
...
export const IntegerTooLarge = FT<{ maximum: number; parameter: string }>('arguments:integerTooLarge');
export const IntegerTooSmall = FT<{ minimum: number; parameter: string }>('arguments:integerTooSmall');
...
export const Snowflake = FT<{ message: Message; parameter: string }>('arguments:snowflake');
