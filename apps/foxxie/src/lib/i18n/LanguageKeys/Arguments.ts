...
export const ModerationEntryLatest = T<string[]>('arguments:moderationEntryLatest');
export const ModerationEntryNone = FT<{ parameter: string }>('arguments:moderationEntryNone');
