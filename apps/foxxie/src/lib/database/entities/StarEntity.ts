...
//             const referencedChannel = cast<TextBasedChannel>(
//                 await referencedGuild.channels.fetch(message.reference.channelId)
//             );
...
//                     await this.edit({ starMessageId: null, enabled: false });
//             }
//         }
