...
@ApplyOptions<ListenerOptions>(({ container }) => ({
	...
	event: FoxxieEvents.GuildMessageDelete
}))
export class UserListener extends Listener<FoxxieEvents.GuildMessageDelete> {
	public async run(...[message, guild, channel]: EventArgs<FoxxieEvents.GuildMessageDelete>) {
