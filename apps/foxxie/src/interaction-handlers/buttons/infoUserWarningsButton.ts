...
export class InfoUserWarningsButtonInteractionHandler extends FoxxieButtonInteractionHandler {
	public override async run(...[interaction, result]: FoxxieButtonInteractionHandler.RunArgs<ParsedInfoUserWarnings>) {
