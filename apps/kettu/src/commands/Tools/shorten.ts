...
@RegisterChatInputCommand(
    builder =>
        builder //
            ...
            .setDescriptionLocalizations(toLocalizationMap(LanguageKeys.Commands.Tools.ShortenDescription))
            .addStringOption(option =>
                option //
                    .setName('url')
                    .setDescription(enUS(LanguageKeys.Commands.Tools.ShortenOptionUrl))
                    .setDescriptionLocalizations(toLocalizationMap(LanguageKeys.Commands.Tools.ShortenOptionUrl))
                    .setRequired(true)
            )
