...
/**
 * Foxxie's Stopwatch class, uses native node to replicate/extend previous performance now dependency.
 */
class Stopwatch {
    /**
	 * Starts a new Stopwatch
	 * @since 3.0
	 * @param {number} [digits] The number of digits to appear after the decimal point when returning the friendly duration
	 */
    constructor(digits) {
        /**
