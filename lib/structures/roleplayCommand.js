...
class RoleplayCommand {
    ...
    async execute(lang, act, args, self){
        ...
        if (this.message.mentions.members && this.message.mentions.members.size > 1) {
            description.push(this.message.guild.language.get(`COMMAND_${act.toUpperCase()}_MULTIPLE`, lang, this.message.member.displayName, this.message.mentions.members.array().slice(0, -1).map(m => m.displayName).join(", ") + `** and **${this.message.mentions.members.last().displayName}`));
            ...
            embed
                .setFooter(this.message.guild.language.get(`COMMAND_${act.toUpperCase()}_FOOTER`, lang, this.message.member.displayName, this.message.mentions.members.first().displayName, authorGiven.toLocaleString(), tarRecieved.toLocaleString()));
...
if (target) {
            description.push(this.message.guild.language.get(`COMMAND_${act.toUpperCase()}_SINGLE`, lang, this.message.member.displayName, target.displayName));
            ...
            let authorGiven = countAuth ? countAuth.given ? countAuth.given : 0 : 0;
            embed
                .setFooter(this.message.guild.language.get(`COMMAND_${act.toUpperCase()}_FOOTER`, lang, this.message.member.displayName, target.displayName, authorGiven.toLocaleString(), tarRecieved.toLocaleString()));
        ...
        if (/(me|myself|mi|self)/i.test(args[0])) {
            description.push(this.message.guild.language.get(`COMMAND_${act.toUpperCase()}_SINGLE`, lang, this.message.guild.me.displayName, this.message.member.displayName))
            ...
            embed
                .setFooter(this.message.guild.language.get(`COMMAND_${act.toUpperCase()}_FOOTER`, lang, this.message.guild.me.displayName, this.message.member.displayName, authorGiven.toLocaleString(), tarRecieved.toLocaleString()));
        ...
        if (!target && self) {
            description.push(`**${this.message.member.displayName}** ${this.message.guild.language.get(`COMMAND_${act.toUpperCase()}_SELF`, lang)}`)
