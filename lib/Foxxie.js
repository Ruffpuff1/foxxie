...
const { EventStore, MonitorStore, Util, TaskStore, InhibitorStore } = require('foxxie');
...
class Foxxie extends Client {
    ...
    launchInhibitors() {
        ...
        for (const file of inFiles) {
            ...
            else console.log(`The inhibitor in ${file} can only be an instance of an Inhibitor class.`)
        };
    }
    ...
    launchTasks() {
        ...
        for (const file of tasks) {
            ...
            else console.log(`The task in ${file} can only be an instance of a Task class.`)
        };
    }
}
