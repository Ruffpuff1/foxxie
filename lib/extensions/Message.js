...
Structures.extend('Message', Message => {
    class FoxxieMessage extends Message {
        ...
        async confirm(message, key, msg, confirmed) {
            ...
            let collector = message.createReactionCollector(user => user.id === msg.author.id);
        ...
        async awaitResponse({ message }, msg, collectedResponses) {
            ...
            if (messages.first().content.toLowerCase() === 'cancel') return msg.edit(this.language.get('MESSAGE_CANCELLED'))
