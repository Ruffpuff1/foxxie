...
const pullRequestBody = [
    ...
    '',
    `This pull request bumps ${packageName} from **${previousRelease?.tag_name ?? 'unknown'}** to **${packageJson.version}**.`,
    '',
...
console.log(`🎉 Creating pull request for ${packageName} ${packageJson.version}`);
